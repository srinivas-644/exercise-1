...
pub struct Person {
    ...
    pub firt_name: ::std::string::String,
...
impl Person {
    ...
    pub fn get_firt_name(&self) -> &str {
        &self.firt_name
    }
    pub fn clear_firt_name(&mut self) {
        self.firt_name.clear();
    }

    // Param is passed by value, moved
    pub fn set_firt_name(&mut self, v: ::std::string::String) {
        self.firt_name = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_firt_name(&mut self) -> &mut ::std::string::String {
        &mut self.firt_name
    }

    // Take field
    pub fn take_firt_name(&mut self) -> ::std::string::String {
        ::std::mem::replace(&mut self.firt_name, ::std::string::String::new())
    }
...
impl ::protobuf::Message for Person {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                2 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.firt_name)?;
                },
                3 => {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if !self.firt_name.is_empty() {
            my_size += ::protobuf::rt::string_size(2, &self.firt_name);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        ...
        if !self.firt_name.is_empty() {
            os.write_string(2, &self.firt_name)?;
        }
        if !self.date.is_empty() {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "firt_name",
                |m: &Person| { &m.firt_name },
                |m: &mut Person| { &mut m.firt_name },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "date",
                |m: &Person| { &m.date },
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x08lastName\x12\x1b\n\tfirt_name\x18\x02\x20\x01(\tR\x08firtName\x12\
    \x12\n\x04date\x18\x03\x20\x01(\tR\x04dateb\x06proto3\
";
